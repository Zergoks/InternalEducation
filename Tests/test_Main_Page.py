...
class TestMainPage:
    ...
    def test_home_page_title_is_correct(self, driver):
        ...
        assert home_page.at_page() is True, (
            f"Не на странице home_page." f"EX: home page" f"AR: {driver.current_url}"
        )
    ...
    def test_header_is_present(self, driver):
        ...
        with allure.step("Проверяем, что header присутствует на странице"):
            assert home_page.header.at_page() is True, "Отсутствует header на странице"
